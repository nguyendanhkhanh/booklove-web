                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        ...
                        <span>
                          <span>Tạ Quyền Anh</span>
                          <span class="time">3 phút trước</span>
                        </span>
                        <span class="message">
                          Nhân viên Đoàn Như thái độ không tốt với khách hàng...
                        </span>
                      </a>
                    </li>
                    <li>
                      <a>
                        <span class="image"><img src="public/imgs/avatar/user-default.jpg" alt="Profile Image" /></span>
                        <span>
                          <span>Vũ Trầm Trọng Nguyên</span>
                          <span class="time">1 giờ trước</span>
                        </span>
                        <span class="message">
                          Voucher giảm giá cho sinh viên và khách hàng thân thiết...
                        </span>
                      </a>
                    </li>
                    <li>
                      <a>
                        ...
                        <span class="message">
                          Cửa hàng nên có thêm chỗ ngồi cho khách...
                        </span>
                      </a>
                    </li>
